...
Ce module comporte le dockerfile permettant de créer les bases de données basées sur [mariadb](https://mariadb.org/) en chargant les scripts pour la géneration des tables ainsi qu'un ensemble de données factices pour pouvoir tester l'interface.
